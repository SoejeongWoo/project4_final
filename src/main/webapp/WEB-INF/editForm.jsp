    ...
    <main>
        ...
        <div class="row g-5" style="display: block;  margin-left: auto; margin-right: auto;">
            <div class="col-md-7 col-lg-8" style="display: block;  margin-left: auto; margin-right: auto;">
                <form action="/p233_22200461_2/update" method="post" class="needs-validation" novalidate="">
                    <div class="row g-3">

                        <div class="col-sm-6">
                            <label for="dramaPoster" class="form-label">메인 이미지</label>
                            <input type="file" class="form-control" name="dramaPoster" id="dramaPoster" placeholder="" value="${drama.dramaPoster}" required="">
                            <div class="invalid-feedback">
                                메인 이미지는 필수 입력입니다.
                            </div>
                        </div>

                        <input type="hidden" class="form-control" name="dramaId" id="dramaId" value="${drama.dramaId}">

                        <div class="col-12">
                            <label for="dramaName" class="form-label">드라마 제목</label>
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" name="dramaName" id="dramaName" placeholder="드라마 제목을 입력하세요" required="" value="${drama.dramaName}">
                                <div class="invalid-feedback">
                                    제목은 필수 입력입니다.
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="date" class="form-control" name="releaseDate" id="releaseDate" value="${drama.releaseDate}">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select" name="genre" id="genre" value="${drama.genre}" required="">
                        ...
                        <div class="col-12">
                            ...
                            <input type="textarea" class="form-control" name="summary" id="summary" value="${drama.summary}"></textarea>
                        </div>
                    ...
                    <button class="w-100 btn btn-primary btn-lg" type="submit" onclick='alert("게시물이 수정되었습니다.")'>수정</button>
                </form>
            </div>
        </div>
    </main>

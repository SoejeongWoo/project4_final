        ...
        <div class="row g-5" style="display: block;  margin-left: auto; margin-right: auto;">
            <div class="col-md-7 col-lg-8" style="display: block;  margin-left: auto; margin-right: auto;">
                <form class="needs-validation" novalidate="">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <label for="firstName" class="form-label">메인 이미지</label>
                        ...
                        <div class="col-12">
                            <label for="username" class="form-label">드라마 제목</label>
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="username" placeholder="드라마 제목을 입력하세요" required="">
                                <div class="invalid-feedback">
                                    제목은 필수 입력입니다.
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <label for="email" class="form-label">출시연도 <span class="text-body-secondary"></span></label>
                            <input type="date" class="form-control" id="email" placeholder="you@example.com">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            <label for="country" class="form-label">장르</label>
                            <select class="form-select" id="country" required="">
                                <option value="volvo">스릴러</option>
                                <option value="saab">로맨스</option>
                                <option value="mercedes">액션</option>
                                <option value="audi">코미디</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            <label for="address2" class="form-label">줄거리 <span class="text-body-secondary"></span></label>
                            <textarea class="form-control" id="address2" placeholder="줄거리를 입력해주세요."></textarea>
                        </div>
                    ...
                    <button class="w-100 btn btn-primary btn-lg" type="submit" onclick="alert('게시물이 추가됩니다.');">저장</button>
                </form>
            </div>
        </div>
    </main>
...
</body></html><html lang="en" data-bs-theme="dark"><head><script src="color-modes.js"></script>
